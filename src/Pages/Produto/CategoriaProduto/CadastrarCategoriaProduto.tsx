...
function CadastrarCategoriaProduto() {
    const [loading, setLoading] = useState(false);
    const [formData, setFormData] = useState<CategoriaProduto>({
        nomeCategoria: ''
    });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            await categoriaProdutoService.cadastrar(formData);
        ...
        <div className="standard-form-container">
            <form onSubmit={handleSubmit}>
                <div className="standard-form-header">
                    ...
                    <p>Preencha os dados abaixo para cadastrar uma nova categoria de produto no sistema.</p>
                </div>
                ...
                <div className="standard-form-grid">
                    <div className="standard-form-group">
                        ...
                        <input 
                            type="text" 
                            id="nomeCategoria" 
                            placeholder="Ex: Eletrônicos, Limpeza, Peças" 
...
export default CadastrarCategoriaProduto;
